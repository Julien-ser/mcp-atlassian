...
async def update_issue(
    ...
    Args:
        ...
        fields: Optional JSON string of fields to update. Text fields like
            'description' use the markup format the parameter schema states. On
            Jira Cloud only, use ``{"parent": null}`` to clear an issue's parent.
            On Server/DC, update the Epic Link custom field directly, such as
            ``{"customfield_10014": null}``.
